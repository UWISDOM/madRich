...
# enrich_method: "hypergeometric" or "gsea." Serves as a sanity check for df filtering, 
...
chooseCutHeight <- function(
  ...
  db_list <- database <- db_format <- subcat <- kmax_holder <- NULL
